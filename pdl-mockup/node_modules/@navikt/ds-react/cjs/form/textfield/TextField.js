...
exports.TextField = (0, react_1.forwardRef)((props, ref) => {
    ...
    return (react_1.default.createElement("div", { className: cn(className, "navds-form-field", `navds-form-field--${size}`, {
        ...
        react_1.default.createElement("input", Object.assign({}, (0, util_1.omit)(rest, ["error", "errorId", "size"]), inputProps, { ref: ref, type: type, readOnly: readOnly, className: cn("navds-text-field__input", "navds-body-short", `navds-body-short--${size !== null && size !== void 0 ? size : "medium"}`), size: htmlSize })),
