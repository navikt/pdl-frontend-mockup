...
const FormSummaryValue_1 = __importDefault(require("./FormSummaryValue"));
/**
...
exports.FormSummary = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement("div", Object.assign({ ref: ref }, rest, { className: cn("navds-form-summary", className) }), children));
});
