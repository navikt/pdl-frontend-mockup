...
exports.CheckboxGroup = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(fieldset_1.Fieldset, Object.assign({}, rest, { ref: ref, className: cn(className, "navds-checkbox-group", `navds-checkbox-group--${(_c = (_b = rest.size) !== null && _b !== void 0 ? _b : fieldset === null || fieldset === void 0 ? void 0 : fieldset.size) !== null && _c !== void 0 ? _c : "medium"}`), nativeReadOnly: false }),
        react_1.default.createElement(exports.CheckboxGroupContext.Provider, { value: {
                value,
                defaultValue,
                toggleValue,
            } },
            react_1.default.createElement("div", { className: cn("navds-checkboxes") }, children))));
});
