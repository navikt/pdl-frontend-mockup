...
exports.FormProgress = (0, react_1.forwardRef)((_a, ref) => {
    ...
    const translate = (0, i18n_hooks_1.useI18n)("FormProgress", translations);
    return (react_1.default.createElement("div", Object.assign({ ref: ref }, rest),
        react_1.default.createElement(progress_bar_1.ProgressBar, { "aria-hidden": true, value: activeStep, valueMax: totalSteps, className: cn("navds-form-progress__bar") }),
        react_1.default.createElement(Collapsible_1.default, { lazy: true, open: open, onOpenChange: onOpenChange },
            react_1.default.createElement(stack_1.HStack, { justify: "space-between", align: "center" },
                react_1.default.createElement(typography_1.BodyShort, { as: "span" }, translate("step", { activeStep, totalSteps })),
                react_1.default.createElement(Collapsible_1.default.Trigger, { asChild: true, "aria-expanded": undefined },
                    react_1.default.createElement(Button_1.default, { variant: "tertiary", size: "small", className: cn("navds-form-progress__button"), icon: react_1.default.createElement(aksel_icons_1.ChevronDownIcon, { "aria-hidden": true }) },
                        react_1.default.createElement("span", { className: cn("navds-form-progress__btn-txt-hide") }, translate("hideAllSteps")),
                        react_1.default.createElement("span", { className: cn("navds-form-progress__btn-txt-show") }, translate("showAllSteps"))))),
            react_1.default.createElement(Collapsible_1.default.Content, { className: cn("navds-form-progress__collapsible") },
                react_1.default.createElement("div", { className: cn("navds-form-progress__collapsible-content") },
                    react_1.default.createElement("div", { className: cn("navds-form-progress__stepper") },
