...
exports.ConfirmationPanel = (0, react_1.forwardRef)((_a, ref) => {
    ...
    const currentRole = hasError
        ...
        : props.checked
            ? "success"
            : "warning";
    return (react_1.default.createElement("div", { className: cn("navds-confirmation-panel", "navds-form-field", className, {
        ...
        react_1.default.createElement("div", { className: cn("navds-form-field__error"), id: errorId, role: "alert" }, showErrorMsg && (react_1.default.createElement(typography_1.ErrorMessage, { size: size, showIcon: true }, props.error)))));
});
