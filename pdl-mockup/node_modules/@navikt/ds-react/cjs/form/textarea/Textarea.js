...
exports.Textarea = (0, react_1.forwardRef)((props, ref) => {
    ...
    const describedBy = (0, clsx_1.default)(inputProps["aria-describedby"], {
        [maxLengthId !== null && maxLengthId !== void 0 ? maxLengthId : ""]: hasMaxLength,
    });
    return (react_1.default.createElement("div", { className: cn(className, "navds-form-field", `navds-form-field--${size}`, {
        ...
        react_1.default.createElement(typography_1.Label, { htmlFor: inputProps.id, size: size, className: cn("navds-form-field__label", {
            ...
            label),
        !!description && (react_1.default.createElement(typography_1.BodyShort, { className: cn("navds-form-field__description", {
                "navds-sr-only": hideLabel,
