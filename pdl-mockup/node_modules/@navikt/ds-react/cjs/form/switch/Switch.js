...
exports.Switch = (0, react_1.forwardRef)((props, ref) => {
    ...
    return (react_1.default.createElement("div", { className: cn("navds-switch", props.className, `navds-switch--${size}`, `navds-switch--${position}`, {
        ...
        react_1.default.createElement("label", { htmlFor: inputProps.id, className: cn("navds-switch__label-wrapper") },
            react_1.default.createElement("div", { className: cn("navds-switch__content", {
                ...
                react_1.default.createElement(typography_1.BodyShort, { as: "div", size: size, className: cn("navds-switch__label") },
