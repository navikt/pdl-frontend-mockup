...
exports.Fieldset = (0, react_1.forwardRef)((props, ref) => {
    ...
    return (react_1.default.createElement(context_1.FieldsetContext.Provider, { value: {
        ...
        react_1.default.createElement("fieldset", Object.assign({}, (0, util_1.omit)(rest, ["errorId", "error", "size", "readOnly"]), (0, util_1.omit)(inputProps, ["aria-describedby", "aria-invalid"]), { ref: ref, className: cn(className, "navds-fieldset", `navds-fieldset--${size}`, {
                "navds-fieldset--error": hasError,
                "navds-fieldset--readonly": readOnly,
            }) }),
            react_1.default.createElement(typography_1.Label, { size: size, as: "legend", className: cn("navds-fieldset__legend", {
                ...
                legend),
            !!description && (react_1.default.createElement(typography_1.BodyShort, { className: cn("navds-fieldset__description", {
                    "navds-sr-only": !!hideLegend,
                }), id: inputDescriptionId, size: size !== null && size !== void 0 ? size : "medium", as: "div" }, props.description)),
            children,
            react_1.default.createElement("div", { id: errorId, "aria-relevant": "additions removals", "aria-live": "polite", className: cn("navds-fieldset__error") }, showErrorMsg && (react_1.default.createElement(typography_1.ErrorMessage, { size: size, showIcon: true }, props.error))))));
});
