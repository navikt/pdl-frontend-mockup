...
exports.Select = (0, react_1.forwardRef)((props, ref) => {
    ...
    return (react_1.default.createElement("div", { className: cn(className, "navds-form-field", `navds-form-field--${size}`, {
        ...
        react_1.default.createElement("div", { className: cn("navds-select__container"), style: style },
            react_1.default.createElement("select", Object.assign({}, (0, util_1.omit)(rest, ["error", "errorId", "size", "readOnly"]), inputProps, readOnlyEventHandlers, { ref: ref, className: cn("navds-select__input", "navds-body-short", `navds-body-short--${size !== null && size !== void 0 ? size : "medium"}`), size: htmlSize }), children),
