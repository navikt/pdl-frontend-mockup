...
const Dropzone = (0, react_1.forwardRef)((props, ref) => {
    ...
    const translate = (0, i18n_hooks_1.useI18n)("FileUpload", { dropzone: translations }, context === null || context === void 0 ? void 0 : context.translations);
    ...
    return (react_1.default.createElement("div", { className: cn("navds-form-field", "navds-dropzone", className, {
        ...
        react_1.default.createElement(typography_1.Label, { htmlFor: inputId, id: labelId, className: cn("navds-form-field__label") }, label),
        !!description && (react_1.default.createElement(typography_1.BodyShort, { id: inputDescriptionId, className: cn("navds-form-field__description"), as: "div" }, description)),
        react_1.default.createElement("div", { className: cn("navds-dropzone__area"), onDragEnter: dropzoneCtx.onDragEnter, onDragOver: dropzoneCtx.onDragOver, onDragLeave: dropzoneCtx.onDragLeave, onDrop: dropzoneCtx.onDrop, onClick: (0, composeEventHandlers_1.composeEventHandlers)(onClick, () => { var _a; return (_a = inputRef.current) === null || _a === void 0 ? void 0 : _a.click(); }), "data-disabled": inputProps.disabled },
            !inputProps.disabled && (react_1.default.createElement(react_1.default.Fragment, null,
                react_1.default.createElement("div", { className: cn("navds-dropzone__area-icon") },
                    react_1.default.createElement(DropzoneIcon, { fontSize: "1.5rem", "aria-hidden": true })),
                react_1.default.createElement("div", { className: cn("navds-dropzone__area-release") },
                    react_1.default.createElement("div", { className: cn("navds-dropzone__area-release__icon") },
                        react_1.default.createElement(DropzoneIcon, { "aria-hidden": true })),
                    react_1.default.createElement("span", { "aria-hidden": !dropzoneCtx.isDraggingOver, className: cn("navds-dropzone__area-release__text") }, translate("dropzone.drop"))),
                ...
                react_1.default.createElement(button_1.Button, Object.assign({}, (0, omit_1.omit)(rest, ["errorId"]), inputPropsRest, { id: buttonId, "aria-describedby": (0, clsx_1.default)(labelId, ariaDescribedby), className: cn("navds-dropzone__area-button"), type: "button", variant: "secondary" }), multiple
                    ? translate("dropzone.buttonMultiple")
                    : translate("dropzone.button")))),
            inputProps.disabled && (react_1.default.createElement("div", { className: cn("navds-dropzone__area-disabled") },
        ...
        react_1.default.createElement("div", { className: cn("navds-form-field__error"), id: errorId, "aria-relevant": "additions removals", "aria-live": "polite" }, showErrorMsg && react_1.default.createElement(typography_1.ErrorMessage, { showIcon: true }, error))));
});
