...
exports.ExpansionCardDescription = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(typography_1.BodyLong, Object.assign({}, rest, { as: "p", ref: ref, className: cn("navds-link-panel__description", className), size: panelContext.size })));
});
