...
exports.Item = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(button_1.Button, Object.assign({ as: Component, variant: themeContext ? "tertiary-neutral" : "tertiary", "aria-current": selected, "data-selected": selected, ref: ref, className: cn("navds-pagination__item", className, {
