...
exports.DropdownToggle = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement("button", Object.assign({}, rest, { ref: (el) => {
        ...
        }, onClick: (0, composeEventHandlers_1.composeEventHandlers)(onClick, handleClick), "aria-expanded": isOpen, className: cn("navds-dropdown__toggle", className) })));
});
exports.default = exports.DropdownToggle;
