...
exports.PageBlock = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(Component, Object.assign({}, rest, { className: cn("navds-pageblock", width && `navds-pageblock--${width}`, className, { "navds-pageblock--gutters": gutters }), ref: ref })));
});
exports.default = exports.PageBlock;
