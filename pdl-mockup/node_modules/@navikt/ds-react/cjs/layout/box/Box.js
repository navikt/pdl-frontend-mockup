...
exports.Box = exports.BoxComponent = void 0;
...
const Box_darkside_1 = __importDefault(require("./Box.darkside"));
/**
 ...
 * </VStack>
 */
exports.BoxComponent = (0, react_1.forwardRef)((_a, ref) => {
    ...
    const style = Object.assign(Object.assign(Object.assign({}, _style), { [`--__${prefix}c-box-background`]: background
            ...
            ? borderWidth
                ...
                .map((x) => `${x}px`)
                .join(" ")
            : undefined }), (0, css_1.getResponsiveProps)(prefix, "box", "border-radius", "border-radius", borderRadius, false, ["0"]));
...
exports.Box = exports.BoxComponent;
exports.Box.New = Box_darkside_1.default;
