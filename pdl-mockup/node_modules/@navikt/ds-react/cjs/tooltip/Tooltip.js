...
exports.Tooltip = (0, react_2.forwardRef)((_a, ref) => {
    ...
    const { x, y, strategy, context, placement, middlewareData: { arrow: { x: arrowX, y: arrowY } = {}, hide: { referenceHidden } = {}, }, refs, } = (0, react_1.useFloating)({
        ...
        middleware: [
            (0, react_1.offset)(_offset !== null && _offset !== void 0 ? _offset : (_arrow ? 8 : 4)),
            (0, react_1.shift)(),
    ...
    return (react_2.default.createElement(react_2.default.Fragment, null,
        ...
        react_2.default.createElement(portal_1.Portal, { rootElement: rootElement, asChild: true }, _open && (react_2.default.createElement("div", Object.assign({}, getFloatingProps(Object.assign(Object.assign({}, rest), { ref: mergedRef, style: {
            ...
            }, role: "tooltip", id: ariaId, className: cn("navds-tooltip", "navds-detail navds-detail--small", className) })), { "data-side": placement, "data-state": "open" }),
            content,
            keys && (react_2.default.createElement("span", { className: cn("navds-tooltip__keys"), "aria-hidden": true }, keys.map((key) => (react_2.default.createElement(typography_1.Detail, { as: "kbd", key: key, className: cn("navds-tooltip__key") }, key))))),
            _arrow && (react_2.default.createElement("div", { ref: (node) => {
                    arrowRef.current = node;
                }, className: cn("navds-tooltip__arrow"), style: {
