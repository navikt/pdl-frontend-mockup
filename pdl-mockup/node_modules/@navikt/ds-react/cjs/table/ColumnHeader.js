...
exports.ColumnHeader = (0, react_1.forwardRef)((_a, ref) => {
    ...
    const context = (0, react_1.useContext)(context_1.TableContext);
    const { cn } = (0, Theme_1.useRenameCSS)();
    if (sortable && !sortKey) {
        console.warn("ColumnHeader with `sortable=true` must have a sortKey.");
    }
    return (react_1.default.createElement(HeaderCell_1.default, Object.assign({ scope: "col", ref: ref, className: cn(className), "aria-sort": sortable
            ? ((_b = context === null || context === void 0 ? void 0 : context.sort) === null || _b === void 0 ? void 0 : _b.orderBy) === sortKey
                ...
                : "none"
            : undefined }, rest), sortable ? (react_1.default.createElement("button", { type: "button", className: cn("navds-table__sort-button"), onClick: sortable && sortKey
