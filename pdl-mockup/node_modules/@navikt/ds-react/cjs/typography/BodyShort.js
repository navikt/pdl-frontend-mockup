...
exports.BodyShort = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(Component, Object.assign({}, rest, { ref: ref, className: cn(className, "navds-body-short", `navds-body-short--${size}`, (0, util_1.typoClassNames)({
            spacing,
            truncate,
            weight,
            align,
