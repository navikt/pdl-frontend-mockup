...
exports.Heading = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(HeadingTag, Object.assign({}, rest, { ref: ref, className: cn(className, "navds-heading", `navds-heading--${size}`, (0, util_1.typoClassNames)({
            spacing,
            align,
            visuallyHidden,
            textColor,
