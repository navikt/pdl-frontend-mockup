...
exports.ToggleChips = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(Component, Object.assign({}, rest, { ref: ref, className: cn("navds-chips__chip navds-chips__toggle", className, `navds-chips__toggle--${variant}`, { "navds-chips__toggle--with-checkmark": checkmark }), "aria-pressed": selected, "data-pressed": selected }),
