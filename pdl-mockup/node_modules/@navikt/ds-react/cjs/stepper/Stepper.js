...
exports.Stepper = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement("ol", Object.assign({}, rest, { ref: ref, className: cn("navds-stepper", orientation === "horizontal" ? "navds-stepper--horizontal" : "", className), "data-orientation": orientation }), react_1.default.Children.map(children, (step, index) => {
        var _a, _b, _c;
        const stepProps = react_1.default.isValidElement(step) ? step.props : {};
        return (react_1.default.createElement("li", { className: cn("navds-stepper__item", {
            ...
            react_1.default.createElement("span", { className: cn("navds-stepper__line navds-stepper__line--1") }),
            react_1.default.createElement(context_1.StepperContextProvider, { interactive: interactive, activeStep: activeStep, lastIndex: react_1.default.Children.count(children), index: index, onStepChange: onStepChange, orientation: orientation }, step),
            react_1.default.createElement("span", { className: cn("navds-stepper__line navds-stepper__line--2") })));
    })));
});
