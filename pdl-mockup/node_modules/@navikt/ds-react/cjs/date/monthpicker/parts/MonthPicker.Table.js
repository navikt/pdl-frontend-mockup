...
exports.MonthPickerTable = void 0;
const date_fns_1 = require("date-fns");
const react_1 = __importStar(require("react"));
const typography_1 = require("../../../typography");
const date_utils_1 = require("../../date-utils");
const MonthPicker_context_1 = require("../MonthPicker.context");
const MonthPicker_Button_1 = __importDefault(require("./MonthPicker.Button"));
const getAllMonths = () => {
    const months = [];
...
const MonthPickerTable = () => {
    ...
    const { selected, year, disabled } = (0, MonthPicker_context_1.useMonthPickerContext)();
    ...
    const getRootFallback = () => {
        ...
        if ((year === null || year === void 0 ? void 0 : year.getFullYear()) === today.getFullYear() &&
            !(0, date_utils_1.isMatch)(today, disabled)) {
            return today;
        }
        for (let i = 0; i < months.length; i++) {
            const m = months[i];
            if (!(0, date_utils_1.isMatch)((0, date_fns_1.setYear)(m, year.getFullYear()), disabled)) {
    ...
    return (react_1.default.createElement(typography_1.BodyShort, { as: "table", className: "rdp-table" },
        react_1.default.createElement("tbody", { className: "rdp-tbody" }, tableMonths.map((tableRow, i) => (react_1.default.createElement("tr", { className: "rdp-row", key: i }, tableRow.map((month) => {
            return (react_1.default.createElement("td", { key: month.toDateString(), className: "rdp-cell" },
                react_1.default.createElement(MonthPicker_Button_1.default, { month: (0, date_fns_1.setYear)(month, year.getFullYear()), months: months, focus: focus, setFocus: setFocus, tabRoot: tabRoot, setTabRoot: setTabRoot })));
        })))))));
};
exports.MonthPickerTable = MonthPickerTable;
