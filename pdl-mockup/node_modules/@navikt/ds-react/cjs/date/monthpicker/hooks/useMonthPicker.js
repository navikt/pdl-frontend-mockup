...
const useMonthpicker = (opt = {}) => {
    ...
    const defaultInputValue = defaultSelected
        ? (0, date_utils_1.formatDateForInput)(defaultSelected, locale, "month", inputFormat)
        : "";
    ...
    const setSelected = (date) => {
        ...
        setInputValue(date ? (0, date_utils_1.formatDateForInput)(date, locale, "month", inputFormat) : "");
    };
    const handleFocus = (e) => {
        var _a;
        ...
        const day = (0, date_utils_1.parseDate)(e.target.value, today, locale, "month", allowTwoDigitYear);
        ...
        if ((0, date_utils_1.isValidDate)(day)) {
            ...
            setInputValue((0, date_utils_1.formatDateForInput)(day, locale, "month", inputFormat));
        }
        else {
            setYear((_a = defaultSelected !== null && defaultSelected !== void 0 ? defaultSelected : defaultYear) !== null && _a !== void 0 ? _a : today);
        }
    ...
    const handleMonthClick = (month) => {
        ...
        updateMonth(month);
        updateValidation();
        setInputValue(month ? (0, date_utils_1.formatDateForInput)(month, locale, "month", inputFormat) : "");
    };
    ...
    const handleChange = (e) => {
        ...
        const month = (0, date_utils_1.parseDate)(e.target.value, today, locale, "month", allowTwoDigitYear);
        const isBefore = getIsBefore({ fromDate, date: month });
        const isAfter = getIsAfter({ toDate, date: month });
        if (!(0, date_utils_1.isValidDate)(month) ||
            (disabled && (0, react_day_picker_1.dateMatchModifiers)(month, disabled))) {
            updateMonth(undefined);
            updateValidation({
                isInvalid: (0, date_utils_1.isValidDate)(month),
                isDisabled: disabled && (0, react_day_picker_1.dateMatchModifiers)(month, disabled),
                isValidMonth: false,
        ...
        if (isAfter ||
            ...
            (fromDate &&
                toDate &&
                !(0, react_day_picker_1.dateMatchModifiers)(month, [{ from: fromDate, to: toDate }]))) {
            updateMonth(undefined);
            updateValidation({
                isValidMonth: false,
                isBefore: isBefore !== null && isBefore !== void 0 ? isBefore : false,
