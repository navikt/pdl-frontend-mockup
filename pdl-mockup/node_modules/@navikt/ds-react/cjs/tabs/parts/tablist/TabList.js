...
exports.TabList = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement("div", { className: cn("navds-tabs__tablist-wrapper") },
        ...
        react_1.default.createElement("div", Object.assign({ ref: mergedRef }, rest, { onScroll: scrollCtx.update, className: cn("navds-tabs__tablist", className), role: "tablist", "aria-orientation": "horizontal", onKeyDown: (0, composeEventHandlers_1.composeEventHandlers)(onKeyDown, _onKeyDown) })),
