...
exports.InternalHeader = (0, react_1.forwardRef)((_a, ref) => {
    ...
    if (themeContext) {
        return (react_1.default.createElement(Theme_1.Theme, { theme: "dark", asChild: true, hasBackground: false },
            react_1.default.createElement("header", Object.assign({}, rest, { ref: ref, className: cn("navds-internalheader", className) }))));
    }
    return (react_1.default.createElement("header", Object.assign({ "data-theme": "dark" }, rest, { ref: ref, className: cn("navds-internalheader", className) })));
});
