...
exports.TimelineRow = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement(react_1.default.Fragment, null,
        label && (react_1.default.createElement(BodyShort_1.BodyShort, { as: headingTag, id: `timeline-row-${id}`, className: cn("navds-timeline__row-label"), size: "small" },
            icon,
            label)),
        react_1.default.createElement("div", { className: cn("navds-timeline__row", {
            ...
            react_1.default.createElement("ol", Object.assign({}, rest, { tabIndex: -1, ref: ref, "aria-label": periods.length === 0
                    ...
                    : translate("Row.period", {
                        start: (0, date_fns_1.format)(earliest.start, translate("dateFormat")),
                        end: (0, date_fns_1.format)(latest.end, translate("dateFormat")),
