...
const Bubble = (0, react_1.forwardRef)((_a, ref) => {
    ...
    return (react_1.default.createElement("div", Object.assign({ ref: ref, className: cn("navds-chat__bubble", className) }, rest),
        (timestamp || name) && (react_1.default.createElement("h3", { className: cn(`navds-chat__top-text`, toptextPosition && `navds-chat__top-text--${toptextPosition}`) },
