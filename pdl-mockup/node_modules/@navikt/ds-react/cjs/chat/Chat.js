...
exports.Chat = (0, react_1.forwardRef)((_a, ref) => {
    var { children, className, name, timestamp, avatar, position = "left", variant = "neutral", toptextPosition, size = "medium" } = _a, rest = __rest(_a, ["children", "className", "name", "timestamp", "avatar", "position", "variant", "toptextPosition", "size"]);
    ...
    return (react_1.default.createElement("div", Object.assign({ ref: ref, className: cn("navds-chat", className, `navds-chat--${position}`, `navds-chat--top-text-${toptextPosition !== null && toptextPosition !== void 0 ? toptextPosition : position}`, `navds-chat--${size}`, `navds-chat--${variant}`) }, rest),
        ...
        react_1.default.createElement("ol", { className: cn("navds-chat__bubble-wrapper") }, react_1.default.Children.map(children, (child, i) => {
            if (react_1.default.isValidElement(child)) {
                return (react_1.default.createElement(typography_1.BodyLong, { as: "li", size: size }, react_1.default.cloneElement(child, Object.assign({ name: name && i === 0 ? name : undefined, timestamp: timestamp && i === 0 ? timestamp : undefined }, child.props))));
            }
        }))));
});
