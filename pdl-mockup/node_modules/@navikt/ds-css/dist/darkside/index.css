...
@layer aksel.theming {
  :root, :host, .light {
    ...
    --ax-meta-purple-400A: rgba(102, 0, 227, .208);
    --ax-meta-purple-300A: rgba(101, 0, 232, .13);
    --ax-meta-purple-200A: rgba(115, 0, 255, .08);
    --ax-meta-purple-100A: rgba(128, 0, 255, .047);
    --ax-meta-purple-1000: #35086b;
    --ax-meta-purple-900: #682eb2;
    --ax-meta-purple-800: #763cc0;
    --ax-meta-purple-700: #7f45c8;
    --ax-meta-purple-600: #925ad6;
    --ax-meta-purple-500: #a370e2;
    --ax-meta-purple-400: #dfcaf9;
    --ax-meta-purple-300: #ebdefc;
    --ax-meta-purple-200: #f4ebff;
    --ax-meta-purple-100: #f9f3ff;
...
@layer aksel.components {
  ...
  .aksel-button--primary .aksel-loader .aksel-loader__background, .aksel-button--danger .aksel-loader .aksel-loader__background {
  ...
  @media (min-width: 480px) {
    .aksel-date, .aksel-date__modal-body {
      padding: var(--ax-space-20);
    }
    ...
    .aksel-date .rdp-button, .aksel-date__caption-button {
      width: 3rem;
      height: 3rem;
    }
  }
  ...
  @starting-style {
    .aksel-action-menu__content[data-state="open"][data-side="bottom"] {
      transform: translateY(-4px);
    }
  }

  @starting-style {
    .aksel-action-menu__content[data-state="open"][data-side="top"] {
      transform: translateY(4px);
    }
  }

  @starting-style {
    .aksel-action-menu__content[data-state="open"][data-side="right"] {
      transform: translateX(-4px);
    }
  }

  @starting-style {
    .aksel-action-menu__content[data-state="open"][data-side="left"] {
      transform: translateX(4px);
    }
  }
  ...
  .aksel-progress-bar__foreground--indeterminate {
    ...
    animation-duration: var(--__ac-progress-bar-simulated), 2.5s;
