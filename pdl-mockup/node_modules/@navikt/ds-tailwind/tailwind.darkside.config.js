module.exports = {
  "theme": {
    ...
    "extend": {
      "boxShadow": {
        "ax-dialog": "var(--ax-shadow-dialog)"
      },
      "fontWeight": {
        "ax-bold": "var(--ax-font-weight-bold)",
        "ax-regular": "var(--ax-font-weight-regular)"
      },
      "fontSize": {
        "ax-heading-2xlarge": "var(--ax-font-size-heading-2xlarge)",
        "ax-heading-xlarge": "var(--ax-font-size-heading-xlarge)",
        "ax-heading-large": "var(--ax-font-size-heading-large)",
        "ax-heading-medium": "var(--ax-font-size-heading-medium)",
        "ax-heading-small": "var(--ax-font-size-heading-small)",
        "ax-heading-xsmall": "var(--ax-font-size-heading-xsmall)",
        "ax-xlarge": "var(--ax-font-size-xlarge)",
        "ax-large": "var(--ax-font-size-large)",
        "ax-medium": "var(--ax-font-size-medium)",
        "ax-small": "var(--ax-font-size-small)"
      },
      "lineHeight": {
        "ax-heading-2xlarge": "var(--ax-font-line-height-heading-2xlarge)",
        "ax-heading-xlarge": "var(--ax-font-line-height-heading-xlarge)",
        "ax-heading-large": "var(--ax-font-line-height-heading-large)",
        "ax-heading-medium": "var(--ax-font-line-height-heading-medium)",
        "ax-heading-small": "var(--ax-font-line-height-heading-small)",
        "ax-heading-xsmall": "var(--ax-font-line-height-heading-xsmall)",
        "ax-xlarge": "var(--ax-font-line-height-xlarge)",
        "ax-large": "var(--ax-font-line-height-large)",
        "ax-medium": "var(--ax-font-line-height-medium)"
      },
      "fontFamily": {
        "ax-font-family": "var(--ax-font-family)"
      },
      "borderRadius": {
        "ax-small": "var(--ax-border-radius-small)",
        "ax-medium": "var(--ax-border-radius-medium)",
        "ax-large": "var(--ax-border-radius-large)",
        "ax-xlarge": "var(--ax-border-radius-xlarge)",
        "ax-full": "var(--ax-border-radius-full)"
      },
      "opacity": {
        "ax-disabled": "var(--ax-opacity-disabled)"
      }
    }
  }
};